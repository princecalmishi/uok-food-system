...
<head>
  ...
  <title>Your order is now confirmed</title>
...
<body style="box-sizing: border-box; margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #f5dbce;">
  <div style="display: none; line-height: 0; font-size: 0;">Hi, your order is now confirmed ✔</div>
  <table class="wrapper all-font-sans" width="100%" height="100%" cellpadding="0" cellspacing="0" id="print-content" role="presentation">
    <tr>
        ...
        <table class="sm-w-full" width="600" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td colspan="2" class="sm-inline-block" style="display: none;">
              <img src="https://images.unsplash.com/photo-1505577058444-a3dab90d4253?ixlib=rb-0.3.5&s=fed02ccbe457c9b8fc1f2cf76f30d755&w=600&h=400&q=80&fit=crop" alt="Room" style="border: 0; line-height: 100%; vertical-align: middle; border-top-left-radius: 4px; border-top-right-radius: 4px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05);">
            </td>
          </tr>
          <tr>
            <td class="sm-hidden" style="padding-top: 40px; padding-bottom: 40px;" width="160">
              <img src="/storage/image/chef.png" alt="uok" style="border: 0; line-height: 100%; vertical-align: middle; border-top-left-radius: 4px; border-bottom-left-radius: 4px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05);" height="350px" width="160">
            </td>
            <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" bgcolor="#ffffff" valign="top">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td width="80%">
                    ...
                    <p class="sm-text-xs" style="margin: 0; color: #a0aec0; font-size: 14px;">Phone: 0728880947</p>
                    <p class="sm-text-xs" style="margin: 0; color: #a0aec0; font-size: 14px;">Web:{{ config('app.name', 'Laravel') }}.com</p>
                  </td>
                  <td style="text-align: right;"  height="100%" width="100%" align="right">
                    <a href="#" target="_blank" style="text-decoration: none;">
                    <!-- <img src="/storage/image/ff.png" alt="uok" style="border: 0; line-height: 100%; vertical-align: middle; border-top-left-radius: 4px; border-bottom-left-radius: 4px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05);" height="350px" width="160"> -->

                      <img src="/storage/image/ff.png" alt="logo" style="height:140px; width:180px">
              ...
              <table class="sm-leading-32" style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="sm-inline-block" style="color: #718096;" width="50%">Customer Name</td>
                  <td class="sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $rname }}</td>
                </tr>
                <tr>
                  <td class="sm-inline-block" style="color: #718096;" width="50%">Invoice Number</td>

                  <td class="sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right"> {{$batch}}</td>
                </tr>
                <tr>
                  <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Phone No</td>
                  <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $rphone }}</td>
                </tr>
              </table>
             ...
             <center> <h5>Your Order </h5></center>
               <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="padding-top: 24px; padding-bottom: 24px;">
                    <div style="background-color: #edf2f7; height: 2px; line-height: 2px;">&zwnj;</div>
              ...
              @foreach($cart as $cart)
                <tr>
                  <td class="sm-w-full sm-inline-block sm-text-center" width="40%">
                    <p class="all-font-roboto" style="margin: 0; margin-bottom: 4px; color: #a0aec0; font-size: 10px; text-transform: uppercase; letter-spacing: 1px;">{{$cart->name}}</p>
                  ...
                  <td class="sm-w-full sm-inline-block sm-text-center" style="text-align: right;" width="40%" align="right">
                    ...
                    <p class="all-font-roboto" style="font-weight: 600; margin: 0; color: #000000;">Ksh :{{$cart->price}}</p>
                  </td>
                </tr>
                @endforeach
              </table>
              ...
              <table style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  ...
                  <td style="font-weight: 600; text-align: right;" width="50%" align="right">Ksh {{$carttotal}}</td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                  ...
                  <td style="font-weight: 600; padding-top: 32px; text-align: right; color: #68d391; font-size: 20px;" width="50%" align="right">Ksh {{$carttotal}}</td>
                </tr>
              </table>
              <center class="mt-5"><p>Thanks for shopping with us. You were served by Ishi</p></center>
            </td>
          </tr>
        </table>
...
<script type="text/javascript">
  ...
  <center> <input type="button" class="btn btn-primary mr-5" onclick="printDiv('print-content')" value="PRINT RECEIPT"/>

  <a class="btn btn-success" href="{{route('dlinvoice')}}">DOWNLOAD RECEIPT</a>
